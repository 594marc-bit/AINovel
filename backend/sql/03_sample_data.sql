...
DECLARE
    ...
    novel3_id INTEGER;
BEGIN
    SELECT id INTO novel1_id FROM novels WHERE title = '星辰之海';
    SELECT id INTO novel2_id FROM novels WHERE title = '江南烟雨';
    SELECT id INTO novel3_id FROM novels WHERE title = '代码人生';
...
这是人类文明的新篇章，也是他个人梦想的实现。', novel1_id, 1),
...
雨声、琴声，交织在一起，构成了这江南最美的画卷。', novel2_id, 1)
    ON CONFLICT (novel_id, chapter_number) DO NOTHING;
...
原来，代码可以如此神奇，可以让机器听从人的指令。从那时起，我知道了这就是我想要的人生。', novel3_id, 1)
    ON CONFLICT (novel_id, chapter_number) DO NOTHING;
END $$;
